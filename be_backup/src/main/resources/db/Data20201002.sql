...
--
-- Dumping data for table `barometric_pressures`
--

LOCK TABLES `barometric_pressures` WRITE;
/*!40000 ALTER TABLE `barometric_pressures` DISABLE KEYS */;
/*!40000 ALTER TABLE `barometric_pressures` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `doctor_interviews`
--

LOCK TABLES `doctor_interviews` WRITE;
/*!40000 ALTER TABLE `doctor_interviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `doctor_interviews` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `footsteps`
--

LOCK TABLES `footsteps` WRITE;
/*!40000 ALTER TABLE `footsteps` DISABLE KEYS */;
/*!40000 ALTER TABLE `footsteps` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `full_symptoms`
--

LOCK TABLES `full_symptoms` WRITE;
/*!40000 ALTER TABLE `full_symptoms` DISABLE KEYS */;
/*!40000 ALTER TABLE `full_symptoms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `haq_answers`
--

LOCK TABLES `haq_answers` WRITE;
/*!40000 ALTER TABLE `haq_answers` DISABLE KEYS */;
/*!40000 ALTER TABLE `haq_answers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `patient_interviews`
--

LOCK TABLES `patient_interviews` WRITE;
/*!40000 ALTER TABLE `patient_interviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `patient_interviews` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `questions` VALUES (1,'衣服の着脱と身支度','靴ひもを結び、ボタン掛けも含め、自分で身支度できますか'),(2,'衣服の着脱と身支度','自分で洗髪できますか'),(3,'起立','肘掛けのない、背もたれが垂直な椅子から立ち上がれますか'),(4,'起立','就寝、起床の動作ができますか'),(5,'食事','皿の上の肉を切ることができますか'),(6,'食事','いっぱいに水が入っている茶碗やコップを口元まで運べますか'),(7,'食事','新しい牛乳のパックの口を開けられますか'),(8,'歩行','戸外で平坦な地面を歩けますか'),(9,'歩行','階段を5段登れますか'),(10,'衛生','身体全体を洗い、タオルで拭くことができますか'),(11,'衛生','浴槽につかることができますか'),(12,'衛生','トイレに座ったり立ったりできますか'),(13,'伸展','頭上にある約2.3kgのもの（百科事典など）を手を伸ばしてつかみ、下に降ろせますか'),(14,'伸展','腰を曲げ床にある衣類を拾い上げられますか'),(15,'握力','自動車のドアを開けられますか'),(16,'握力','広口のビンの蓋を開けられますか（既に口を切ってあるもの）'),(17,'握力','蛇口の開閉ができますか'),(18,'活動','用事や買物で出掛けることができますか'),(19,'活動','車の乗降りができますか'),(20,'活動','掃除機をかけたり、拭掃除などの家事ができますか');
...
-- Dump completed on 2020-10-02 15:37:09
