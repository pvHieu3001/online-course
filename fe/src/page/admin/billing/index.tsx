import { Row, Col, Card, Statistic, Button, List, Descriptions, Avatar, Flex } from 'antd'
          ...
          <Row gutter={[24, 0]}>
            ...
            <Col xs={24} className='mb-24'>
              <Card className='header-solid h-full ant-card-p-0'>
                <Flex className='ant-row-flex ant-row-flex-middle' align='center' justify='space-between'>
                  <h6 className='font-semibold m-0'>Payment Methods</h6>
                  <Button
                    style={{ background: darkColor, color: 'white', fontSize: '12px' }}
            ...
            <List
              ...
              renderItem={(item) => (
                <List.Item
                  actions={[
                    <Button type='link'>
                      <Flex align='center' justify='center' style={{ color: '#3a416f' }}>
                        <PictureAsPdfRoundedIcon /> <span>PDF</span>
                      </Flex>
                    </Button>
                  ]}
                >
