  ...
  return (
    <HandleLoading isLoading={coursesLoading} error_message={courseError}>
      <div className='bg-gray-100 py-8 min-h-screen px-4'>
        <Helmet>
          <title>Hocfree || {category.name}</title>
          <meta
            name='description'
            content={`Discover free courses about ${category.name} on Hocfree — learn from basic to advanced, suitable for beginners and those wanting to improve their skills.`}
          />
        </Helmet>
