...
function CategoryDetailPage() {
    ...
    const courses = [
        {
            id: 1,
            image: 'https://i.imgur.com/euT3ZqY.png', // thay bằng ảnh thật nếu có
        ...
        {
            id: 2,
            image: 'https://i.imgur.com/NGEXCqT.png', // thay bằng ảnh thật nếu có
            category: 'Adobe After Affects · All Courses',
    ...
    return (
        <>
            ...
            <div>
                <div className={styles.categoryLabel}>Category - Adobe After Affects</div>
