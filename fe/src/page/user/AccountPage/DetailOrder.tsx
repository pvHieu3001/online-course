...
import HandleAnimationIcon from '../../components/icon/OrderIcon/Handle'
import PrepareSuccessAnimationIcon from '../../components/icon/OrderIcon/PrepareSuccess'
import DeliverAnimationIcon from '../../components/icon/OrderIcon/DeliverSuccess'
import PrepareAnimationIcon from '../../components/icon/OrderIcon/Prepare'
import DoneOrderAnimationIcon from '../../components/icon/OrderIcon/DoneOrder'
import OrderCancelAnimationIcon from '../../components/icon/OrderIcon/OrderCancel'
import DeliveringAnimationIcon from '../../components/icon/OrderIcon/Delivering'
import PickupAnimationIcon from '../../components/icon/OrderIcon/PickUp'
    ...
    return (
      <div key={index} className='flex py-4 sm:py-7 last:pb-0 first:pt-0'>
        <div className='h-24 w-16 sm:w-20 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100'>
          <img src={image || thumbnail} alt={name} className='h-full w-full object-cover object-center' />
        </div>
      ...
      <Row gutter={16}>
                  ...
                  <div className='relative pb-8'>
                    <div className='relative flex space-x-3 flex-col justify-center items-center'>
                      <div className='flex items-center justify-center w-[50px] h-full'>
                        <div
                          className={`h-[40px] w-[40px] rounded-full  flex items-center justify-center ring-8 ring-white bg-green-400`}
                        >
        ...
        <Col span={24} className=' border-t-[1px]'>
          ...
          <div className='flex justify-end border-solid border-b-[1px] border-b-[#eee] '>
            ...
            <span className=' px-3 w-[240px] flex justify-end'>
              {VND(Number(dataItem?.total_price) - Number(dataItem?.discount_price))}
            </span>
          </div>
          <div className='flex justify-end border-solid border-b-[1px] border-b-[#eee] '>
          ...
          <div className='flex justify-end border-solid border-b-[1px] border-b-[#eee] '>
            ...
            <b className='text-[19px] text-red-500 p-3 w-[240px] flex justify-end'>
              {VND(Number(dataItem?.discount_price))}
            </b>
          </div>
        </Col>
      </Row>
